...
// Fetch available slots for interviews
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <?php if ($status === 'Not_applied' || $status === 'Rejected'): ?>
                <p>
                    <?= $status === 'Rejected' ? "Your previous application was not approved. You may reapply below." : "You have not applied for the scholarship yet. Submit your application below."; ?>
                </p>

                <!-- Display Slot Information -->
                <div class="alert <?= $availableSlots > 0 ? 'alert-success' : 'alert-danger'; ?>">
                    <strong>Interview Slots:</strong> <?= $availableSlots > 0 ? "$availableSlots available" : "No slots available at the moment"; ?>.
                </div>
                ...
                <?php else: ?>
                    <p class="text-danger">You cannot apply for the scholarship as no slots are currently available. Please check back later.</p>
                <?php endif; ?>
